...
Para materializar esse engajamento, o projeto apoia-se na curiosidade inerente ao gênero \textit{Creature Capture} \cite{Portnow2012}, preenchendo uma lacuna teórica e estética identificada a partir dos trabalhos correlatos. Enquanto o \textit{ChemCraft} concentra-se em reações diretas e o \textit{ChemCaper} em um RPG tradicional, o Alchemon inova ao adotar uma estética de criaturas única para cada elemento químico. Superando os modelos baseados apenas em cartas ou fórmulas geométricas, essa escolha de \textit{design} atua como um \textit{cantilevers} conceituais \cite{Bryce2024}: as mecânicas de captura facilitam a memorização visual e ancoram os novos conhecimentos químicos de forma não arbitrária e substantiva, conforme a TAS \cite{Ausubel1963, Espirito2020}.
