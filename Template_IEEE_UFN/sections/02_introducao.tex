...
\begin{itemize}
    ...
    \item Projetar a arquitetura do jogo por meio de um \textit{Game Design Document} (GDD), definindo mecânicas de captura e colecionismo que operem como organizadores prévios alinhados aos níveis de \enquote{Lembrar} e \enquote{Entender} da Taxonomia de Bloom;
