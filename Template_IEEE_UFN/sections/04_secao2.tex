...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.4\textwidth]{images/chemcaper.jpg}
    \caption{Interface do jogo ChemCaper: Act I - Petticles in Peril - Fonte: \cite{AceEdVenture2016}}
    \label{fig:chemcaper}
\end{figure}

\subsection{ChemCraft}

O \textit{ChemCraft}, desenvolvido por Jihae Han \cite{Han2021}, Fig. \ref{fig:chemcraft}, é um jogo \textit{Creature Capture} 2D focado no ensino de Química Orgânica de nível superior (\textit{IB Higher Level}). O objetivo do projeto foi investigar a transposição de sistemas químicos reais para regras de sistemas digitais, seguindo o conceito de \textit{gaming literacy}.
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.4\textwidth]{images/chemcraft.jpg}
    \caption{Interface do jogo ChemCraft. Fonte: \cite{Han2021}} 
    \label{fig:chemcraft}
\end{figure}

\subsection{Batalha QuímiCard}

No cenário educacional brasileiro, o Batalha QuímiCard \cite{GomesdeFreitas2017}, Fig. \ref{fig:batalhaquimicard} é um jogo sério de cartas digital desenvolvido para a plataforma Android. O objetivo do jogo é validar o uso de mecânicas inspiradas em títulos comerciais para o ensino de ácidos e bases, concentrando-se especificamente nas forças relativas das substâncias e nas constantes de equilíbrio $K_a$ e $K_b$ \cite{GomesdeFreitas2017}.
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.4\textwidth]{images/batalhaquimicard.png}
    \caption{Interface do jogo Batalha Quimicard. Fonte: \cite{GomesdeFreitas2017}}
    \label{fig:batalhaquimicard}
\end{figure}
